...
public class SignalExtendedObserverItem extends BlockItem {
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String REGISTRY_NAME = "signal_extended_observer_item";
    public static final ResourceLocation RESOURCE_LOCATION = new ResourceLocation(RedstoneAdditionsMod.MOD_ID, REGISTRY_NAME);
    public static final RegistryObject<SignalExtendedObserverItem> REGISTRY_OBJECT = RegistryObject.of(RESOURCE_LOCATION, ForgeRegistries.ITEMS);
    public static final SignalExtendedObserverItem ITEM = new SignalExtendedObserverItem();

    private SignalExtendedObserverItem() {
        super(SignalExtendedObserverBlock.BLOCK, new Properties().maxStackSize(64).group(ItemGroup.REDSTONE));
